...
Deno.writeTextFileSync(resolve(import.meta.dirname!, '../web/status.json'), JSON.stringify(regions));
...
Deno.writeTextFileSync(resolve(import.meta.dirname!, '../web/sources.json'), JSON.stringify(sources, null, 2));