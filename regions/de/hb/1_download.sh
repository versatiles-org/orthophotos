...
mkdir -p ../tiles_hb
mkdir -p ../tiles_bhv
find files_hb -type f -name "*.jpg" | parallel --eta --bar mv {} ../tiles_hb/
find files_hb -type f -name "*.wld" | parallel --eta --bar mv {} ../tiles_hb/{.}.jgw
find files_bhv -type f -name "*.tif" | parallel --eta --bar mv {} ../tiles_bhv/
